...
numbers = []
n = ''
print('Введите числа для формирования списка. Чтобы завершить ввод введите команду stop')
while n != 'stop':
    try:
        n = input('Введите число: ')
        if not n.isdigit():
            raise NotDigSym('Вы ввели не число')
        else:
            numbers.append(int(n))
    except NotDigSym as err:
        print(err)
